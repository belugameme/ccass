...
# hkex_ccass_scraper documentation build
...
from hkex_ccass_scraper import __version__ as release

# -- Project information -----------------------------------------------------

project = "hkex_ccass_scraper"
author = "Kedro"
...
htmlhelp_basename = "hkex_ccass_scraperdoc"
...
latex_documents = [
    (
        master_doc,
        "hkex_ccass_scraper.tex",
        "hkex_ccass_scraper Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "hkex_ccass_scraper",
        "Project hkex_ccass_scraper codebase.",
        "Data-Science",
    )
]
